/*
  ...
  1. New Tables
    - `user_progress` - Track daily nutrition logs and progress
    - `achievements` - Define available achievements and badges
    - `user_achievements` - Track user's earned achievements
    - `community_recipes` - User-shared recipes with ratings
    - `grocery_lists` - Save and share grocery lists
    - `meal_plans` - Save generated meal plans
    - `user_streaks` - Track various user streaks
